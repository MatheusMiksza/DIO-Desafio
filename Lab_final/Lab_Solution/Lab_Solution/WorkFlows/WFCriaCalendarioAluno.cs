...
namespace Lab_Solution.WorkFlows
{
    public class WFCriarCalendarioAluno : CodeActivity
    {
        ...
        [ReferenceTarget("dio_alunoxcursodisponvel")]
        ...
        protected override void Execute(CodeActivityContext executionContext)
        {
            ...
            Entity entityAlunoXCursoDisponivel = service.Retrieve("dio_alunoxcursodisponvel", guidAlunoXCurso,
            ...
            if (entityAlunoXCursoDisponivel != null)
            {
                ...
                guidCurso = ((EntityReference)entityAlunoXCursoDisponivel.Attributes["dio_cursoselecionado"]).Id;
            ...
            {
                Entity entityCurso = service.Retrieve("dio_cursosdisponiveis", guidCurso, new ColumnSet("dio_duracao"));
                int horasDuracao = 0;
                ...
                if (diasNecessarios > 0)
                {
                    for (int i = 0; i < diasNecessarios; i++)
                    {
                        ...
                        entCalendarioAluno["dio_alunoxcursodisponivel"] = new EntityReference("dio_alunoxcursodisponvel", guidAlunoXCurso);
